...
- [The Rustonomicon](https://doc.rust-lang.org/nomicon/) — Advanced guide to unsafe Rust and low-level details (Advanced)
...
- [rust-learning](https://github.com/ctjhoa/rust-learning) — Collection of useful Rust learning resources including blog posts, articles, and tutorials
...
### Free Courses
- [Rustlings](https://github.com/rust-lang/rustlings) — Official small exercises to learn Rust syntax and concepts, run from your terminal (Beginner)
- [100 Exercises to Learn Rust](https://rust-exercises.com/) — Luca Palmieri's progressive, hands-on Rust challenges (Beginner)
- [Comprehensive Rust (Google)](https://google.github.io/comprehensive-rust/) — Free 4-day course developed by Google's Android team, used internally at Google (Beginner)
...
### Practice & Challenges
- [Exercism Rust Track](https://exercism.org/tracks/rust) — Mentored coding exercises with community feedback (Beginner)
...
- [Rust Quiz](https://dtolnay.github.io/rust-quiz/) — Tricky Rust quiz questions to test deep language understanding (Advanced)
...
- [No Boilerplate](https://www.youtube.com/@NoBoilerplate) — Compelling explanations of why Rust and how Rust concepts work (Beginner)
...
- [The Rustonomicon](https://doc.rust-lang.org/nomicon/) — Free advanced guide to unsafe Rust (Advanced)
...
- [Comprehensive Rust (Google)](https://google.github.io/comprehensive-rust/) — Google's free 4-day Rust course covering fundamentals through Android development (Beginner)
...
- [miri](https://github.com/rust-lang/miri) — Interpreter for detecting undefined behavior in unsafe Rust code
...
- [Shuttle](https://www.shuttle.rs/) — Build, deploy, and manage Rust web services with zero infrastructure config
